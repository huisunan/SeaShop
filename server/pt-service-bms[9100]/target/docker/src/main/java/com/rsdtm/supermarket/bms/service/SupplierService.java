...
import static com.rsdtm.supermarket.common.enums.ExceptionEnum.*;
...
public class SupplierService {
    ...
    public int updateSupplier(BmsSupplier bmsSupplier){
        ...
        BmsSupplier temp = new BmsSupplier();
        temp.setId(bmsSupplier.getId());
        int i = supplierDao.selectCount(temp);
        if (i==0)
