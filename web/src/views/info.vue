<template>
    ...
    <div id='write' class='is-node'><h2><a name='header-n179' class='md-header-anchor '></a>项目介绍</h2>
        <p> 对生鲜销售通过全面的信息采集和处理并辅助提高超市的决策水平，可以迅速提升超市的管理水平，为降低经营成本，提高效益，增强超市的扩张力，提供有效的技术保障。</p>
        <h3><a name='header-n182' class='md-header-anchor '></a>组织结构</h3>
        <pre spellcheck="false" class="md-fences md-end-block ty-contain-cm modeLoaded" lang=""><div
                ...
                class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;">pt-parent</span></pre></div><pre
                class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;">├── pt-api -- controller接口和文档的编写</span></pre><pre
                class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;">├── pt-common -- 通用代码</span></pre><pre
                class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;">├── pt-gateway[9000] -- 路由模块及权限验证模块</span></pre><pre
                class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;">├── pt-log -- 全局日志模块</span></pre><pre
                class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;">├── pt-mbg -- 实体类模块</span></pre><pre
                class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;">├── pt-registry[9010] -- 微服务注册中心</span></pre><pre
                class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;">├── pt-service-bms[9100] -- 基础模块微服务</span></pre><pre
                class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;">├── pt-service-oms[9120] -- 订单模块微服务</span></pre><pre
                class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;">├── pt-service-ums[9110] -- 用户模块微服务</span></pre><pre
                class=" CodeMirror-line " role="presentation"><span role="presentation" style="padding-right: 0.1px;">├── pt-upload[9020] -- 文件上传模块</span></pre></div></div></div></div></div><div
        ...
        <h3><a name='header-n184' class='md-header-anchor '></a>技术选型</h3>
        <figure>
            <table>
                <thead>
                <tr>
                ...
                <tr>
                    ...
                    <td style='text-align:left;'>认证和授权框架</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style='text-align:left;'>MyBatisGenerator</td>
                    <td style='text-align:left;'>数据层实体类生成</td>
                </tr>
                <tr>
                    <td style='text-align:left;'>PageHelper</td>
                    <td style='text-align:left;'>MyBatis物理分页插件</td>
                </tr>
                <tr>
                    <td style='text-align:left;'>Swagger-UI</td>
                    <td style='text-align:left;'>文档生产工具</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style='text-align:left;'>JWT登录支持</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style='text-align:left;'>通用Mapper</td>
                    <td style='text-align:left;'>简化单表的增删改查操作</td>
                </tr>
                </tbody>
            </table>
        </figure>
        <h4><a name='header-n222' class='md-header-anchor '></a>前端技术</h4>
        <figure>
            <table>
                <thead>
                <tr>
                ...
                <tr>
                    <td>vue-element-admin-template</td>
                    <td>基于Vue+Element的简单管理后台模板</td>
                </tr>
                </tbody>
            </table>
        </figure>
        <h4><a name='header-n245' class='md-header-anchor '></a>项目分工</h4>
        <figure>
            <table>
                <thead>
                <tr>
